...
const CreateItem = () => {
  ...
  async function onSubmit(e) {
    ...
    if (images.length > 6) {
      toast.error("Please add at most five images");
      setLoading(false);
      return;
    }
    ...
    if (geolocationEnabled) {
      const response = await fetch(
        `https://maps.googleapis.com/maps/api/geocode/json?key=${
          import.meta.env.VITE_REACT_TOKO_MALIK_GEOCODING_API_KEY
        }&address=${address}`
      );
    ...
    <main className="max-w-md px-2 mx-auto pb-6">
      ...
      <form onSubmit={onSubmit}>
        ...
        <textarea
          ...
          placeholder="Address"
          required
          className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 mb-4"
        />
